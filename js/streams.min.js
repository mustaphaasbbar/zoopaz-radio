...
function getHashValue(a){console.log("action="+a);var b=window.location.hash,b=b.replace(/^#/,""),b=b.split("/");switch(b[1]){case a:return decodeURIComponent(b[2]);default:return!1}}isRadioMode=!1;
